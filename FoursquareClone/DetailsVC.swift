...
class DetailsVC: UIViewController , MKMapViewDelegate, CLLocationManagerDelegate{
    ...
    override func viewDidLoad() {
        ...
        navigationController?.navigationBar.topItem?.leftBarButtonItem = UIBarButtonItem(title: "< Back", style: UIBarButtonItem.Style.plain, target: self, action: #selector(goToPlacesVC))
        
    }
    @objc func goToPlacesVC() {
        self.performSegue(withIdentifier: "toBackPlacesVC", sender: nil)
    }
